...
const LoginPage = () => {
  ...
  return (
    <form onSubmit={onSubmit} className="auth-form">
      ...
      <Input className="mt-3" icon={() => <FiLock />} placeholder="Password" hidden innerRef={passwordRef} />
      ...
      <p>
        Do not have an account? <PageLink to={routes.registerRoute()}> Register! </PageLink>{" "}
      </p>
    </form>
  );
};
